 ...
 * void setHintMess(String message) that take a given a message, and show it on the view, void
 * clearField() that clear the text field, void resetFocus() to  reset focus.
 */
